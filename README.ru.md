...
| Построение цепочки | — | поиск пути: недостающее звено, лишний сертификат и якорь внутри цепочки разрешаются |
| Выбор сертификата | — | режим «любой сохранённый» — импортировали CA сервера и подключились, вручную выбирать не нужно |
