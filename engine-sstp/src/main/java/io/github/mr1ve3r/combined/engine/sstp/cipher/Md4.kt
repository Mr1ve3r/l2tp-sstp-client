...
// The variable names come from RFC 1320, which spells the MD4 registers A, B, C
// and D and its non-linear functions F, G and H. Renaming them to satisfy a
// style rule would make this file impossible to check against the RFC, which is
// the only way anyone can be sure a hash implementation is right.
