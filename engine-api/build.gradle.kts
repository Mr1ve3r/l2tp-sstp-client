...
// Protocol-agnostic engine contract (SPEC phase 2). Depends on nothing but coroutines and the Android SDK: no Flutter, no concrete engine.
plugins {
...
android {
    namespace = "io.github.mr1ve3r.combined.engine"
